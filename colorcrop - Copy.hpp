...
void find_coord(int32_t action, uint32_t* img, uint32_t* colors, int32_t width, int32_t height, int32_t color_length,
    ...
    switch (action) {
            case 0:
                ...
                break;
            case 1:
                find_end_x(img, colors, width, height, color_length, end_x);
                break;
            case 2:
                find_start_y(img, colors, width, height, color_length, end_x);
                break;
            case 3:
                find_end_y(img, colors, width, height, color_length, end_x);
                break;
            default:
                break;
